...
simulated_time_to_treatment <- rbeta(nrow(Traumabase.imputed), 2, 5, ncp = 0)*350
...
```{r}
total$Glasgow.initial <- as.integer(total$Glasgow.initial) + 3
total$Glasgow.initial <- total$Glasgow.initial/4
total$Glasgow.initial <- 4*floor(total$Glasgow.initial)
