...
EXTENDED_SHIFTED_SET <- c(EXTENDED_PRECISION_SET,  "Glasgow.initial")
...
for (i in 1:500){
  ...
  simulation <- simulation.semi.synthetic(n = 3000, m = 15000, source.data = total.with.overlap, extra.noise.on.high.ttt = TRUE)
